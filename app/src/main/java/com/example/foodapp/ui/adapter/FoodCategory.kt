...
//import com.example.foodapp.data.model.food.FoodHomeUI
//
//class FoodCategory (private val imgList: List<FoodHomeUI>): RecyclerView.Adapter<FoodCategory.viewHolder>() {
